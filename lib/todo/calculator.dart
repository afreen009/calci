                  ...
                  child: Table(
                    children: [
                      TableRow(children: [
                        ...
                        buildButton("⌫", 1, lightblue),
                        buildButton("÷", 1, lightblue),
                      ]),
                      TableRow(children: [
                        buildButton("7", 1, blue),
                        buildButton("8", 1, blue),
                        buildButton("9", 1, blue),
                      ]),
                      TableRow(children: [
                        buildButton("4", 1, blue),
                        buildButton("5", 1, blue),
                        buildButton("6", 1, blue),
                      ]),
                      TableRow(children: [
                        buildButton("1", 1, blue),
                        buildButton("2", 1, blue),
                        buildButton("3", 1, blue),
                      ]),
                      TableRow(children: [
                        buildButton(".", 1, blue),
                        buildButton("0", 1, blue),
                        buildButton("00", 1, blue),
                      ]),
                    ],
                  ),
                ),
